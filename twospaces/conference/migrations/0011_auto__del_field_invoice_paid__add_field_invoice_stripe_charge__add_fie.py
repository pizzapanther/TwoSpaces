...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'conference_invoice', 'paid')

        # Adding field 'Invoice.stripe_charge'
        db.add_column(u'conference_invoice', 'stripe_charge',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Invoice.paid_on'
        db.add_column(u'conference_invoice', 'paid_on',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'conference_invoice', 'paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Invoice.stripe_charge'
        db.delete_column(u'conference_invoice', 'stripe_charge')

        # Deleting field 'Invoice.paid_on'
        db.delete_column(u'conference_invoice', 'paid_on')
    ...
    models = {
        ...
        u'conference.invoice': {
            ...
            'stripe_charge': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'stripe_token': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'subject': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'text': ('django.db.models.fields.TextField', [], {'default': "'Follow the link below to complete your sponsorship transaction.'"}),
