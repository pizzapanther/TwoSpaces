...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'conference_invoice', 'name',
                      self.gf('django.db.models.fields.CharField')(default='NARF', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.name'
        db.delete_column(u'conference_invoice', 'name')
