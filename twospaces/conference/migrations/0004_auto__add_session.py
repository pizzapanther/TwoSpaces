...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'conference_session', (
            ...
            ('stype', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('status', self.gf('django.db.models.fields.CharField')(default='submitted', max_length=25)),
            ...
            ('special_requirements', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'conference', ['Session'])


    def backwards(self, orm):
        # Deleting model 'Session'
        db.delete_table(u'conference_session')
