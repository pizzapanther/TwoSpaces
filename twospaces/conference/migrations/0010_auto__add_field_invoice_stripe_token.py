...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.stripe_token'
        db.add_column(u'conference_invoice', 'stripe_token',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.stripe_token'
        db.delete_column(u'conference_invoice', 'stripe_token')
