...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'conference_session', 'level',
                      self.gf('django.db.models.fields.CharField')(default='beginner', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.level'
        db.delete_column(u'conference_session', 'level')
