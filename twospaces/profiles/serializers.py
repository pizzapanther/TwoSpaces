...
class UserSizzler(DynamicFieldsMixin, serializers.ModelSerializer):
  ...
  class Meta:
    model = User
    fields = ('username', 'email', 'password', 'name', 'image', 'biography',
              'website', 'social_handles', 'phone')
...
class UserUpdateSizzler(UserSizzler):
  ...
  class Meta:
    model = User
    fields = ('username', 'email', 'password', 'name', 'first_name',
              'last_name', 'image', 'biography', 'website', 'social_handles',
              'phone')
