...
main_patterns = patterns('twospaces.conference.views',
  ...
  url(r'^([-\w]+)/submit-lightning-talk/$', 'conference_submit_talk', name='conference-submit-lightning-talk', kwargs={'talk': 'lightning'}),
  ...
  url(r'^([-\w]+)/talks/(\d+)/$', 'conference_talk_detail', name='conference-talk-detail'),
